...
const searchBuy = require("./routes/searchFilter/buy");
const searchRent = require("./routes/searchFilter/rent");

//Application config
let url = "add your own string";
...
app.use("/real-estates/search/buy", searchBuy);
app.use("/real-estates/search/rent", searchRent);
...
app.listen(port, ()=> console.log("Application has started at port 3000!"));